# === Ex 2: 알고리즘 패러다임 판별 연습 ===
# Week 07 중간고사 리뷰 - 알고리즘 패러다임 식별 훈련
# 10개의 문제를 통해 Brute Force, Divide & Conquer, Greedy, DP 패러다임을 판별하는 연습
"""
알고리즘 패러다임 판별 연습
...
# PROBLEMS 리스트: 10개의 알고리즘 문제를 딕셔너리 형태로 저장
# 각 문제는 id, title, description 필드를 가진다
PROBLEMS = [
    {
        "id": 1,
        "title": "배열에서 두 수의 합",
...
def print_problems():
    ...
    PROBLEMS 리스트를 순회하며 각 문제의 제목과 설명을 출력.
    사용자가 직접 패러다임을 판별할 수 있도록 답은 비워 둔다.
    """
    print("=" * 65)
...
def print_solutions():
    ...
    각 문제에 대한 정답 패러다임과 상세한 설명을 출력.
    왜 해당 패러다임이 적합한지, 시간 복잡도는 어떤지 등을 포함.
    """
    print("\n" + "=" * 65)
    print(" 해설")
    print("=" * 65)
...
def print_summary():
    ...
    4가지 패러다임(BF, D&C, Greedy, DP)의 특성과 판별 기준을 정리.
    문제를 볼 때 어떤 순서로 패러다임을 고려해야 하는지 가이드를 제공.
    """
    print("\n" + "=" * 65)
    print(" 패러다임 판별 가이드")
    print("=" * 65)
