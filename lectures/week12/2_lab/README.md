...
`examples/skeletons/ex1_dijkstra.py` — Dijkstra implementation using heapq.

### Ex 2: Bellman-Ford (10 min)
`examples/skeletons/ex2_bellman_ford.py` — Shortest paths in graphs with negative edge weights.
